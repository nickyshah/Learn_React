...
const AddContact = () => {
  return (
    <div className='border row text-white p-2'>
       ...
       <div className="col-12 col-md-4 p-1">
        <input type="text" className="form-control form-control-sm" placeholder='Email...'></input>
       </div>

       <div className="col-12 col-md-4 p-1">
        <input type="text" className="form-control form-control-sm" placeholder='Phone...'></input>
       </div>
