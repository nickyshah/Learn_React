...
class AddContact extends React.Component {
  ...
  handleAddContactFormSubmit = (e) => {
    ...
    const email = e.target.elements.contactName.value.trim()
    
    const phone = e.target.elements.contactName.value.trim()
  ...
  return (
    <div className='border col-12 text-white p-2'>
      <form action="" onSubmit={this.handleAddContactFormSubmit}>
